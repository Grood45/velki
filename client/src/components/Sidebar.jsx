...
const Sidebar = ({ isSidebarOpen, toggleSidebar }) => {
  ...
  return (
    <div
      className={`absolute top-0 left-0 bg-[#eef6fb] z-40 w-3/4 h-screen ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
    ...
    >
      ...
      <div className="mt-3">
        <ul className="mx-6 flex flex-col gap-3">
          ...
          <li className=" bg-[#d4e0e5] rounded-2xl">
            <button
              onClick={handleLogout}
              className="flex items-center justify-between w-full p-3 text-gray-800"
            >
              <div className="flex items-center gap-2">
